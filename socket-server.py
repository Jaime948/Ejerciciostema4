...
socket_server.listen(5) #Numero Máximo de conexiones
...
while salir == False:
    ...
    while True:
        ...
        elif message == 'bienvenido':                                         
            message = ("¡bienvenido!, para continuar eliga una opcion:\n\n1.- Variables válidas."
